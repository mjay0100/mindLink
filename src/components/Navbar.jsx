...
//       <div className="fixed inset-y-0 w-0 left-0 z-50">
//         <div
//           ref={sidebarRef}
//           className={`h-full ${
...
//                         onClick={closeSidebar}
//                       >
//                         <FaSmile className="mr-2" /> Anxiety Disorder Assessment
//                       </Link>
//                     </li>
//                     <li>
//                       <Link
...
//                         onClick={closeSidebar}
//                       >
//                         <FaPills className="mr-2" /> Substance Abuse Assessment
//                       </Link>
//                     </li>
//                     <li>
//                       <Link
...
//                         onClick={closeSidebar}
//                       >
//                         <FaHeadSideVirus className="mr-2" /> Dementia Assessment
//                       </Link>
//                     </li>
//                   </ul>
//                 )}
...
//         className={`fixed top-4 left-4 w-0 text-gray-800 z-50 lg:hidden ${
